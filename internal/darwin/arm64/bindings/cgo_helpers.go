...
func (x *Iovec) PassRef() (*C.struct_iovec, *cgoAllocMap) {
	...
	ref4b778f8.iov_base, ciov_base_allocs = *(*unsafe.Pointer)(unsafe.Pointer(&x.Iov_base)), cgoAllocsUnknown
...
func (x *Iovec) Deref() {
	...
	x.Iov_base = (unsafe.Pointer)(unsafe.Pointer(x.ref4b778f8.iov_base))
